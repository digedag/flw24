...
class Search {
	...
	public function getJoinsMatch($params, $parent) {
		if(isset($params['tableAliases']['TEAM1FEUSER'])) {
			...
			$params['join'] .= ' JOIN tx_cfcleague_club2feusers_mm AS usr1 ON t1.club = usr1.uid_local ';
		}
		if(isset($params['tableAliases']['TEAM2FEUSER'])) {
			...
			$params['join'] .= ' JOIN tx_cfcleague_club2feusers_mm AS usr2 ON t2.club = usr2.uid_local ';
		}
	}
